...
3) If you roll a Pokemon that has a 10% or lower catch rate (which will be stated next to the Pokemon name), then you have the option to treat it as a traditional Nuzlocke catch or as a Wildcard.
4) Water on routes with both land and water are special (for now). You can choose to catch one or the other, or both.
5) You have access to other optional rules like the Wobbuffet Clause or the Shiny Clause.
...
- Eventually adding the ability to add different challenge modifiers (such as BST or type limits) and modify the list of generated Pokemon as well
- Randomizing different challenge modifiers for each run and pick the list accordingly
